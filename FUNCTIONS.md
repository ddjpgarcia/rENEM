...
| `enem_trend(var, years)` | Serie temporal ponderada de una variable del **panel armonizado** (`mujer`, `edad_grupo`, ISCO-08, `pdte_acuerdo`/`pdte_aprueba`) | Funcional (necesita `survey`) | `enem_load()` |
